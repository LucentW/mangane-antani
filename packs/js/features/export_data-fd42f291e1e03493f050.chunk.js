"use strict";
(self["webpackChunkposterdati_fe"] = self["webpackChunkposterdati_fe"] || []).push([[36],{
...
/* harmony import */ var soapbox_actions_snackbar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! soapbox/actions/snackbar */ 23);
/* harmony import */ var soapbox_api__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! soapbox/api */ 7);
/* harmony import */ var soapbox_normalizers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! soapbox/normalizers */ 25);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                accounts = [];
                next = (0,soapbox_api__WEBPACK_IMPORTED_MODULE_1__.getLinks)(apiResponse).refs.find(function (link) { return link.rel === 'next'; });
                _a.label = 1;
            case 1:
                if (!next) return [3 /*break*/, 3];
                return [4 /*yield*/, (0,soapbox_api__WEBPACK_IMPORTED_MODULE_1__["default"])(getState).get(next.uri)];
            case 2:
                apiResponse = _a.sent();
                next = (0,soapbox_api__WEBPACK_IMPORTED_MODULE_1__.getLinks)(apiResponse).refs.find(function (link) { return link.rel === 'next'; });
                ...
                return [3 /*break*/, 1];
            case 3:
                accounts = followings.map(function (account) { return (0,soapbox_normalizers__WEBPACK_IMPORTED_MODULE_2__.normalizeAccount)(account).fqn; });
...
var exportFollows = function () { return function (dispatch, getState) {
    ...
    var me = getState().me;
    return (0,soapbox_api__WEBPACK_IMPORTED_MODULE_1__["default"])(getState).get("/api/v1/accounts/".concat(me, "/following?limit=40")).then(listAccounts(getState)).then(function (followings) {
...
var exportBlocks = function () { return function (dispatch, getState) {
    ...
    return (0,soapbox_api__WEBPACK_IMPORTED_MODULE_1__["default"])(getState).get('/api/v1/blocks?limit=40').then(listAccounts(getState)).then(function (blocks) {
...
var exportMutes = function () { return function (dispatch, getState) {
    ...
    return (0,soapbox_api__WEBPACK_IMPORTED_MODULE_1__["default"])(getState).get('/api/v1/mutes?limit=40').then(listAccounts(getState)).then(function (mutes) {
...
var _this = undefined;
var _jsxFileName = "/home/runner/work/mangane-antani/mangane-antani/app/soapbox/features/export_data/components/csv_exporter.tsx";
...
var CSVExporter = function (_ref) {
    ...
    return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(soapbox_components_ui__WEBPACK_IMPORTED_MODULE_1__.Form, {
        __self: _this,
        __source: {
    ...
    }, intl.formatMessage(messages.input_label)), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(soapbox_components_ui__WEBPACK_IMPORTED_MODULE_1__.Text, {
        theme: "muted",
        __self: _this,
        __source: {
            fileName: _jsxFileName,
    ...
    }, intl.formatMessage(messages.input_hint)), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(soapbox_components_ui__WEBPACK_IMPORTED_MODULE_1__.FormActions, {
        __self: _this,
        __source: {
            fileName: _jsxFileName,
            lineNumber: 37,
...
/* harmony import */ var soapbox_actions_export_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! soapbox/actions/export_data */ 1851);
/* harmony import */ var _ui_components_column__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../ui/components/column */ 857);
/* harmony import */ var _components_csv_exporter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/csv_exporter */ 1852);
var _this = undefined;
var _jsxFileName = "/home/runner/work/mangane-antani/mangane-antani/app/soapbox/features/export_data/index.tsx";
...
//# sourceMappingURL=export_data-fd42f291e1e03493f050.chunk.js.map