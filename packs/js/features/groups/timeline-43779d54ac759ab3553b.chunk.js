"use strict";
(self["webpackChunkposterdati_fe"] = self["webpackChunkposterdati_fe"] || []).push([[48],{
...
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! react-router-dom */ 10);
...
/* harmony import */ var _actions_group_editor__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../actions/group_editor */ 367);
...
var _dec, _class, _class2, _jsxFileName = "/home/runner/work/mangane-antani/mangane-antani/app/soapbox/features/groups/edit/index.js";
...
/* harmony import */ var soapbox_components_ui__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! soapbox/components/ui */ 2);
/* harmony import */ var _actions_groups__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../actions/groups */ 298);
/* harmony import */ var _components_scrollable_list__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../components/scrollable_list */ 856);
/* harmony import */ var _containers_account_container__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../containers/account_container */ 292);
/* harmony import */ var _ui_components_column__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../ui/components/column */ 857);
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var _dec, _class, _class2, _jsxFileName = "/home/runner/work/mangane-antani/mangane-antani/app/soapbox/features/groups/members/index.js";
function _defineProperty(obj, key, value) { if (key in obj) {
    Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });
}
else {
...
var GroupMembers = (_dec = (0,react_redux__WEBPACK_IMPORTED_MODULE_5__.connect)(mapStateToProps), _dec(_class = (_class2 = /** @class */ (function (_super) {
    __extends(GroupMembers, _super);
    function GroupMembers() {
        var _this = _super.apply(this, arguments) || this;
        _defineProperty(_this, "handleLoadMore", lodash_debounce__WEBPACK_IMPORTED_MODULE_0___default()(function () {
            _this.props.dispatch((0,_actions_groups__WEBPACK_IMPORTED_MODULE_7__.expandMembers)(_this.props.params.id));
        }, 300, {
            leading: true
        }));
        return _this;
    ...
    GroupMembers.prototype.componentDidMount = function () {
        ...
        this.props.dispatch((0,_actions_groups__WEBPACK_IMPORTED_MODULE_7__.fetchMembers)(id));
    };
    GroupMembers.prototype.componentDidUpdate = function (prevProps) {
        if (this.props.params.id !== prevProps.params.id) {
            this.props.dispatch((0,_actions_groups__WEBPACK_IMPORTED_MODULE_7__.fetchMembers)(this.props.params.id));
        }
    };
    GroupMembers.prototype.render = function () {
        ...
        if (!group || !accountIds) {
            return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_2__.createElement(_ui_components_column__WEBPACK_IMPORTED_MODULE_10__["default"], {
                __self: this,
                __source: {
                    fileName: _jsxFileName,
                    lineNumber: 56,
        ...
        }, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_2__.createElement(_components_scrollable_list__WEBPACK_IMPORTED_MODULE_8__["default"], {
            scrollKey: "members",
            hasMore: hasMore,
            onLoadMore: this.handleLoadMore,
            emptyMessage: /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_2__.createElement(react_intl__WEBPACK_IMPORTED_MODULE_11__["default"], {
        ...
        }, accountIds.map(function (id) { /*#__PURE__*/ return react__WEBPACK_IMPORTED_MODULE_2__.createElement(_containers_account_container__WEBPACK_IMPORTED_MODULE_9__["default"], {
            key: id,
            id: id,
            withNote: false,
            __self: _this,
    ...
    accountIds: (react_immutable_proptypes__WEBPACK_IMPORTED_MODULE_3___default().orderedSet),
    hasMore: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().bool)
}), _class2)) || _class);
...
var _dec, _class, _class2, _jsxFileName = "/home/runner/work/mangane-antani/mangane-antani/app/soapbox/features/groups/removed_accounts/index.js";
function _defineProperty(obj, key, value) { if (key in obj) {
    Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });
}
else {
...
var GroupRemovedAccounts = (_dec = (0,react_redux__WEBPACK_IMPORTED_MODULE_5__.connect)(mapStateToProps), _dec(_class = (0,react_intl__WEBPACK_IMPORTED_MODULE_12__["default"])(_class = (_class2 = /** @class */ (function (_super) {
    __extends(GroupRemovedAccounts, _super);
    function GroupRemovedAccounts() {
        var _this = _super.apply(this, arguments) || this;
        _defineProperty(_this, "handleLoadMore", lodash_debounce__WEBPACK_IMPORTED_MODULE_0___default()(function () {
            _this.props.dispatch((0,_actions_groups__WEBPACK_IMPORTED_MODULE_7__.expandRemovedAccounts)(_this.props.params.id));
        }, 300, {
            leading: true
        }));
        _defineProperty(_this, "handleOnActionClick", function (group, id) {
            return function () {
                _this.props.dispatch((0,_actions_groups__WEBPACK_IMPORTED_MODULE_7__.removeRemovedAccount)(group.get('id'), id));
            };
        });
        return _this;
    }
    GroupRemovedAccounts.prototype.componentDidMount = function () {
        var id = this.props.params.id;
        this.props.dispatch((0,_actions_groups__WEBPACK_IMPORTED_MODULE_7__.fetchRemovedAccounts)(id));
    };
    GroupRemovedAccounts.prototype.componentDidUpdate = function (prevProps) {
        if (this.props.params.id !== prevProps.params.id) {
            this.props.dispatch((0,_actions_groups__WEBPACK_IMPORTED_MODULE_7__.fetchRemovedAccounts)(this.props.params.id));
        }
    };
    GroupRemovedAccounts.prototype.render = function () {
        ...
        return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_2__.createElement(_ui_components_column__WEBPACK_IMPORTED_MODULE_10__["default"], {
            ...
            hasMore: hasMore,
            onLoadMore: this.handleLoadMore,
            emptyMessage: /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_2__.createElement(react_intl__WEBPACK_IMPORTED_MODULE_13__["default"], {
...
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! react-router-dom */ 17);
/* harmony import */ var soapbox_components_ui__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! soapbox/components/ui */ 2);
/* harmony import */ var _soapbox_features_compose_containers_compose_form_container__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../soapbox/features/compose/containers/compose_form_container */ 1409);
/* harmony import */ var _actions_streaming__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../actions/streaming */ 62);
/* harmony import */ var _actions_timelines__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../actions/timelines */ 32);
/* harmony import */ var _components_avatar__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../components/avatar */ 611);
/* harmony import */ var _components_missing_indicator__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../components/missing_indicator */ 538);
/* harmony import */ var _ui_components_timeline__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../ui/components/timeline */ 1403);
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var _dec, _class, _class2, _jsxFileName = "/home/runner/work/mangane-antani/mangane-antani/app/soapbox/features/groups/timeline/index.js";
function _defineProperty(obj, key, value) { if (key in obj) {
    Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });
}
else {
...
var GroupTimeline = (_dec = (0,react_redux__WEBPACK_IMPORTED_MODULE_3__.connect)(mapStateToProps), _dec(_class = (0,react_intl__WEBPACK_IMPORTED_MODULE_11__["default"])(_class = (_class2 = /** @class */ (function (_super) {
    ...
    function GroupTimeline() {
        ...
        _defineProperty(_this, "handleLoadMore", function (maxId) {
            ...
            _this.props.dispatch((0,_actions_timelines__WEBPACK_IMPORTED_MODULE_7__.expandGroupTimeline)(id, {
                maxId: maxId
            }));
        });
        return _this;
    ...
    GroupTimeline.prototype.componentDidMount = function () {
        ...
        var id = this.props.params.id;
        dispatch((0,_actions_timelines__WEBPACK_IMPORTED_MODULE_7__.expandGroupTimeline)(id));
        this.disconnect = dispatch((0,_actions_streaming__WEBPACK_IMPORTED_MODULE_6__.connectGroupStream)(id));
    };
    ...
    GroupTimeline.prototype.render = function () {
        ...
        if (typeof group === 'undefined' || !relationships) {
            return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1__.createElement(soapbox_components_ui__WEBPACK_IMPORTED_MODULE_4__.Column, {
                __self: this,
                __source: {
                    fileName: _jsxFileName,
                    lineNumber: 69,
            ...
            }, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1__.createElement(soapbox_components_ui__WEBPACK_IMPORTED_MODULE_4__.Spinner, {
                __self: this,
                __source: {
                    fileName: _jsxFileName,
                    lineNumber: 70,
            ...
            return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1__.createElement(_components_missing_indicator__WEBPACK_IMPORTED_MODULE_9__["default"], {
                __self: this,
                __source: {
                    fileName: _jsxFileName,
                    lineNumber: 75,
        ...
        return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", {
        ...
        }, relationships.get('member') && /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", {
        ...
        }, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1__.createElement(_components_avatar__WEBPACK_IMPORTED_MODULE_8__["default"], {
            account: account,
            size: 46,
            __self: this,
            __source: {
        ...
        })), /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1__.createElement(_soapbox_features_compose_containers_compose_form_container__WEBPACK_IMPORTED_MODULE_5__["default"], {
            group: group,
            shouldCondense: true,
            autoFocus: false,
            __self: this,
        ...
        }, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1__.createElement(_ui_components_timeline__WEBPACK_IMPORTED_MODULE_10__["default"], {
            alwaysPrepend: true,
            ...
            emptyMessage: /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1__.createElement(react_intl__WEBPACK_IMPORTED_MODULE_13__["default"], {
...
}(react__WEBPACK_IMPORTED_MODULE_1__.PureComponent)), _defineProperty(_class2, "propTypes", {
    params: (prop_types__WEBPACK_IMPORTED_MODULE_0___default().object.isRequired),
    dispatch: (prop_types__WEBPACK_IMPORTED_MODULE_0___default().func.isRequired),
    columnId: (prop_types__WEBPACK_IMPORTED_MODULE_0___default().string),
    hasUnread: (prop_types__WEBPACK_IMPORTED_MODULE_0___default().bool),
    group: prop_types__WEBPACK_IMPORTED_MODULE_0___default().oneOfType([(react_immutable_proptypes__WEBPACK_IMPORTED_MODULE_2___default().map), (prop_types__WEBPACK_IMPORTED_MODULE_0___default().bool)]),
    relationships: (react_immutable_proptypes__WEBPACK_IMPORTED_MODULE_2___default().map),
    account: (react_immutable_proptypes__WEBPACK_IMPORTED_MODULE_2___default().record),
...
//# sourceMappingURL=timeline-43779d54ac759ab3553b.chunk.js.map