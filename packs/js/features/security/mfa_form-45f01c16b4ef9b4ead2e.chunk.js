"use strict";
(self["webpackChunkposterdati_fe"] = self["webpackChunkposterdati_fe"] || []).push([[67],{
...
/* harmony import */ var soapbox_actions_mfa__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! soapbox/actions/mfa */ 860);
...
var _this = undefined;
var _jsxFileName = "/home/runner/work/mangane-antani/mangane-antani/app/soapbox/features/security/mfa/disable_otp_form.tsx";
...
var DisableOtpForm = function () {
    ...
    var handleSubmit = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function () {
        setIsLoading(true);
        dispatch((0,soapbox_actions_mfa__WEBPACK_IMPORTED_MODULE_1__.disableMfa)('totp', password)).then(function () {
            dispatch(soapbox_actions_snackbar__WEBPACK_IMPORTED_MODULE_2__["default"].success(intl.formatMessage(messages.mfaDisableSuccess)));
            history.push('../auth/edit');
        }).finally(function () {
            setIsLoading(false);
        }).catch(function () {
            dispatch(soapbox_actions_snackbar__WEBPACK_IMPORTED_MODULE_2__["default"].error(intl.formatMessage(messages.disableFail)));
        });
    ...
    return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(soapbox_components_ui__WEBPACK_IMPORTED_MODULE_3__.Form, {
        ...
        hintText: /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_intl__WEBPACK_IMPORTED_MODULE_8__["default"], {
...
/* harmony import */ var soapbox_hooks__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! soapbox/hooks */ 3);
var _this = undefined;
var _jsxFileName = "/home/runner/work/mangane-antani/mangane-antani/app/soapbox/features/security/mfa/enable_otp_form.tsx";
...
var EnableOtpForm = function (_ref) {
    ...
    var intl = (0,react_intl__WEBPACK_IMPORTED_MODULE_6__["default"])();
    var history = (0,react_router_dom__WEBPACK_IMPORTED_MODULE_7__.useHistory)();
    var _a = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]), backupCodes = _a[0], setBackupCodes = _a[1];
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
        dispatch((0,soapbox_actions_mfa__WEBPACK_IMPORTED_MODULE_1__.fetchBackupCodes)()).then(function (_ref2) {
            var backupCodes = _ref2.codes;
            setBackupCodes(backupCodes);
        }).catch(function () {
            dispatch(soapbox_actions_snackbar__WEBPACK_IMPORTED_MODULE_2__["default"].error(intl.formatMessage(messages.codesFail)));
        });
    }, []);
    ...
    })), backupCodes.length > 0 ? /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    ...
    }, backupCodes.map(function (code, i) { /*#__PURE__*/ return react__WEBPACK_IMPORTED_MODULE_0__.createElement(soapbox_components_ui__WEBPACK_IMPORTED_MODULE_3__.Text, {
        key: i,
        theme: "muted",
        size: "sm",
        __self: _this,
    ...
    }, code); })) : /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(soapbox_components_ui__WEBPACK_IMPORTED_MODULE_3__.Spinner, {
        __self: _this,
        __source: {
            fileName: _jsxFileName,
            lineNumber: 59,
    ...
    })))), !displayOtpForm && /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(soapbox_components_ui__WEBPACK_IMPORTED_MODULE_3__.FormActions, {
        __self: _this,
        __source: {
            fileName: _jsxFileName,
            lineNumber: 66,
    ...
    }), backupCodes.length > 0 && /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(soapbox_components_ui__WEBPACK_IMPORTED_MODULE_3__.Button, {
        theme: "primary",
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var qrcode_react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! qrcode.react */ 1412);
...
/* harmony import */ var soapbox_actions_mfa__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! soapbox/actions/mfa */ 860);
...
var _this = undefined;
var _jsxFileName = "/home/runner/work/mangane-antani/mangane-antani/app/soapbox/features/security/mfa/otp_confirm_form.tsx";
...
var OtpConfirmForm = function () {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function () {
        dispatch((0,soapbox_actions_mfa__WEBPACK_IMPORTED_MODULE_2__.setupMfa)('totp')).then(function (data) {
            setState(function (prevState) { return _objectSpread(_objectSpread({}, prevState), {}, {
                qrCodeURI: data.provisioning_uri,
                confirmKey: data.key
            }); });
        }).catch(function () {
            dispatch(soapbox_actions_snackbar__WEBPACK_IMPORTED_MODULE_3__["default"].error(intl.formatMessage(messages.qrFail)));
        });
    }, []);
    var handleInputChange = (0,react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(function (event) {
        event.persist();
    ...
    var handleSubmit = function (e) {
        ...
        dispatch((0,soapbox_actions_mfa__WEBPACK_IMPORTED_MODULE_2__.confirmMfa)('totp', state.code, state.password)).then(function (r) {
            dispatch(soapbox_actions_snackbar__WEBPACK_IMPORTED_MODULE_3__["default"].success(intl.formatMessage(messages.mfaConfirmSuccess)));
            history.push('../auth/edit');
        }).catch(function () {
            dispatch(soapbox_actions_snackbar__WEBPACK_IMPORTED_MODULE_3__["default"].error(intl.formatMessage(messages.confirmFail)));
            setState(function (prevState) { return _objectSpread(_objectSpread({}, prevState), {}, {
                isLoading: false
            }); });
        });
    ...
    return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1__.createElement(soapbox_components_ui__WEBPACK_IMPORTED_MODULE_4__.Stack, {
    ...
    }, "1. ", /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1__.createElement(react_intl__WEBPACK_IMPORTED_MODULE_9__["default"], {
    ...
    }), state.confirmKey, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1__.createElement(soapbox_components_ui__WEBPACK_IMPORTED_MODULE_4__.Text, {
        weight: "semibold",
        size: "lg",
        __self: _this,
        __source: {
    ...
    }, "2. ", /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1__.createElement(react_intl__WEBPACK_IMPORTED_MODULE_9__["default"], {
        ...
        hintText: /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1__.createElement(react_intl__WEBPACK_IMPORTED_MODULE_9__["default"], {
...
/* harmony import */ var _mfa_disable_otp_form__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./mfa/disable_otp_form */ 1856);
/* harmony import */ var _mfa_enable_otp_form__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./mfa/enable_otp_form */ 1857);
/* harmony import */ var _mfa_otp_confirm_form__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./mfa/otp_confirm_form */ 1858);
var _this = undefined;
var _jsxFileName = "/home/runner/work/mangane-antani/mangane-antani/app/soapbox/features/security/mfa_form.tsx";
...
var MfaForm = function () {
    ...
    var _a = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false), displayOtpForm = _a[0], setDisplayOtpForm = _a[1];
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
        dispatch((0,soapbox_actions_mfa__WEBPACK_IMPORTED_MODULE_1__.fetchMfa)());
    }, []);
    var handleSetupProceedClick = function (event) {
        event.preventDefault();
        setDisplayOtpForm(true);
    };
    var mfa = (0,soapbox_hooks__WEBPACK_IMPORTED_MODULE_3__.useAppSelector)(function (state) { return state.security.get('mfa'); });
    ...
    }, mfa.getIn(['settings', 'totp']) ? /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mfa_disable_otp_form__WEBPACK_IMPORTED_MODULE_4__["default"], {
        __self: _this,
        __source: {
            fileName: _jsxFileName,
            lineNumber: 48,
    ...
    }) : /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mfa_enable_otp_form__WEBPACK_IMPORTED_MODULE_5__["default"], {
    ...
    }), displayOtpForm && /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mfa_otp_confirm_form__WEBPACK_IMPORTED_MODULE_6__["default"], {
        __self: _this,
        __source: {
            fileName: _jsxFileName,
            lineNumber: 52,
...
//# sourceMappingURL=mfa_form-45f01c16b4ef9b4ead2e.chunk.js.map