"use strict";
(self["webpackChunkposterdati_fe"] = self["webpackChunkposterdati_fe"] || []).push([[30],{
...
/* harmony import */ var soapbox_components_permalink__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! soapbox/components/permalink */ 865);
/* harmony import */ var soapbox_components_ui__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! soapbox/components/ui */ 2);
/* harmony import */ var soapbox_features_ui_components_action_button__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! soapbox/features/ui/components/action-button */ 562);
...
var _this = undefined;
var _jsxFileName = "/home/runner/work/mangane-antani/mangane-antani/app/soapbox/features/directory/components/account_card.tsx";
...
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! react-router-dom */ 10);
/* harmony import */ var soapbox_actions_directory__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! soapbox/actions/directory */ 469);
...
/* harmony import */ var soapbox_components_ui_toggle_toggle__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! soapbox/components/ui/toggle/toggle */ 883);
/* harmony import */ var soapbox_features_ui_components_column__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! soapbox/features/ui/components/column */ 857);
/* harmony import */ var soapbox_hooks__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! soapbox/hooks */ 3);
/* harmony import */ var soapbox_utils_features__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! soapbox/utils/features */ 16);
/* harmony import */ var _components_account_card__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/account_card */ 2363);
var _this = undefined;
var _jsxFileName = "/home/runner/work/mangane-antani/mangane-antani/app/soapbox/features/directory/index.tsx";
...
var Directory = function () {
    ...
    var search = (0,react_router_dom__WEBPACK_IMPORTED_MODULE_12__.useLocation)().search;
    var params = new URLSearchParams(search);
    var accountIds = (0,soapbox_hooks__WEBPACK_IMPORTED_MODULE_7__.useAppSelector)(function (state) { return state.user_lists.directory.items; });
    var title = (0,soapbox_hooks__WEBPACK_IMPORTED_MODULE_7__.useAppSelector)(function (state) { return state.instance.get('title'); });
    var features = (0,soapbox_hooks__WEBPACK_IMPORTED_MODULE_7__.useAppSelector)(function (state) { return (0,soapbox_utils_features__WEBPACK_IMPORTED_MODULE_8__.getFeatures)(state.instance); });
    var _a = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(params.get('order') || 'active'), order = _a[0], setOrder = _a[1];
    var _b = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(!!params.get('local')), local = _b[0], setLocal = _b[1];
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function () {
        dispatch((0,soapbox_actions_directory__WEBPACK_IMPORTED_MODULE_3__.fetchDirectory)({
            order: order || 'active',
            local: local || false
        }));
    }, [order, local]);
    ...
    var handleLoadMore = function () {
        dispatch((0,soapbox_actions_directory__WEBPACK_IMPORTED_MODULE_3__.expandDirectory)({
            order: order || 'active',
            local: local || false
        }));
    };
    return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1__.createElement(soapbox_features_ui_components_column__WEBPACK_IMPORTED_MODULE_6__["default"], {
    ...
    }, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1__.createElement(soapbox_components_ui_toggle_toggle__WEBPACK_IMPORTED_MODULE_5__["default"], {
        id: "new-arrivals",
        checked: order === 'new',
    ...
    }, intl.formatMessage(messages.newArrivals))), features.federating && /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", {
        className: "directory__filter-form__column flex items-center gap-2",
        role: "group",
        __self: _this,
        __source: {
        ...
        className: classnames__WEBPACK_IMPORTED_MODULE_0___default()('directory__list'),
        __self: _this,
        __source: {
            fileName: _jsxFileName,
            lineNumber: 69,
    ...
    }, accountIds.map(function (accountId) { /*#__PURE__*/ return react__WEBPACK_IMPORTED_MODULE_1__.createElement(_components_account_card__WEBPACK_IMPORTED_MODULE_9__["default"], {
        id: accountId,
        key: accountId,
        __self: _this,
        __source: {
    ...
    }, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1__.createElement(soapbox_components_load_more__WEBPACK_IMPORTED_MODULE_4__["default"], {
...
//# sourceMappingURL=directory-7568d21418a479cc8d24.chunk.js.map