"use strict";
(self["webpackChunkposterdati_fe"] = self["webpackChunkposterdati_fe"] || []).push([[38],{
...
/* harmony import */ var soapbox_actions_accounts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! soapbox/actions/accounts */ 15);
/* harmony import */ var soapbox_actions_favourites__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! soapbox/actions/favourites */ 466);
/* harmony import */ var soapbox_components_missing_indicator__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! soapbox/components/missing_indicator */ 538);
/* harmony import */ var soapbox_components_status_list__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! soapbox/components/status_list */ 452);
...
/* harmony import */ var soapbox_utils_features__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! soapbox/utils/features */ 16);
/* harmony import */ var _ui_components_column__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../ui/components/column */ 857);
...
var _dec, _class, _class2, _jsxFileName = "/home/runner/work/mangane-antani/mangane-antani/app/soapbox/features/favourited_statuses/index.js";
...
var mapStateToProps = function (state, _ref) {
    ...
    var features = (0,soapbox_utils_features__WEBPACK_IMPORTED_MODULE_12__.getFeatures)(state.get('instance'));
    if (isMyAccount) {
        return {
    ...
    if (accountFetchError) {
        ...
        var account = (0,soapbox_selectors__WEBPACK_IMPORTED_MODULE_11__.findAccountByUsername)(state, username);
...
var Favourites = (_dec = (0,react_redux__WEBPACK_IMPORTED_MODULE_5__.connect)(mapStateToProps), _dec(_class = (0,react_intl__WEBPACK_IMPORTED_MODULE_15__["default"])(_class = (_class2 = /** @class */ (function (_super) {
    ...
    function Favourites() {
        ...
        _defineProperty(_this, "handleLoadMore", lodash_debounce__WEBPACK_IMPORTED_MODULE_0___default()(function () {
            ...
            if (isMyAccount) {
                _this.props.dispatch((0,soapbox_actions_favourites__WEBPACK_IMPORTED_MODULE_7__.expandFavouritedStatuses)());
            }
            else {
                _this.props.dispatch((0,soapbox_actions_favourites__WEBPACK_IMPORTED_MODULE_7__.expandAccountFavouritedStatuses)(accountId));
            }
        }, 300, {
            leading: true
        }));
    ...
    Favourites.prototype.componentDidMount = function () {
        ...
        if (isMyAccount)
            this.props.dispatch((0,soapbox_actions_favourites__WEBPACK_IMPORTED_MODULE_7__.fetchFavouritedStatuses)());
        else {
            if (accountId && accountId !== -1) {
                this.props.dispatch((0,soapbox_actions_accounts__WEBPACK_IMPORTED_MODULE_6__.fetchAccount)(accountId));
                this.props.dispatch((0,soapbox_actions_favourites__WEBPACK_IMPORTED_MODULE_7__.fetchAccountFavouritedStatuses)(accountId));
            }
            else {
                this.props.dispatch((0,soapbox_actions_accounts__WEBPACK_IMPORTED_MODULE_6__.fetchAccountByUsername)(username));
            }
        }
    };
    ...
    Favourites.prototype.render = function () {
        ...
        if (!isMyAccount && !isAccount && accountId !== -1) {
            return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_2__.createElement(soapbox_components_missing_indicator__WEBPACK_IMPORTED_MODULE_8__["default"], {
                __self: this,
                __source: {
        ...
        if (accountId === -1) {
            return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_2__.createElement(_ui_components_column__WEBPACK_IMPORTED_MODULE_13__["default"], {
                __self: this,
                __source: {
                    fileName: _jsxFileName,
                    lineNumber: 124,
            ...
            }, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_2__.createElement(soapbox_components_ui__WEBPACK_IMPORTED_MODULE_10__.Spinner, {
                __self: this,
                __source: {
                    fileName: _jsxFileName,
                    lineNumber: 125,
        ...
        var emptyMessage = isMyAccount ? /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_2__.createElement(react_intl__WEBPACK_IMPORTED_MODULE_16__["default"], {
        ...
        }, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_2__.createElement(soapbox_components_status_list__WEBPACK_IMPORTED_MODULE_9__["default"], {
            statusIds: statusIds,
    ...
    statusIds: (react_immutable_proptypes__WEBPACK_IMPORTED_MODULE_3___default().orderedSet.isRequired),
    ...
    isMyAccount: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().bool.isRequired)
...
/* harmony import */ var soapbox_components_missing_indicator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! soapbox/components/missing_indicator */ 538);
/* harmony import */ var soapbox_components_ui__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! soapbox/components/ui */ 2);
/* harmony import */ var soapbox_features_ui_containers_bundle_container__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! soapbox/features/ui/containers/bundle_container */ 38);
/* harmony import */ var soapbox_features_ui_util_async_components__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! soapbox/features/ui/util/async-components */ 30);
...
var _this = undefined;
var _jsxFileName = "/home/runner/work/mangane-antani/mangane-antani/app/soapbox/features/profile_fields/index.tsx";
...
//# sourceMappingURL=favourited_statuses-e16dc1e3a03e26bf7954.chunk.js.map